...
def run_test_files(folder_path, test_type, file_details, global_id):
    ...
    for file in os.listdir(folder_path):
        if file.endswith('.java'):
            ...
            # print(expected_lines, compiler_error_lines)
            success = expected_lines == compiler_error_lines
...
def main():
    ...
    valid_types = {"-lexical": "test_files/lexical_errors", "-syntax": "test_files/syntax_errors", "-semantic": "test_files/semantic_errors", "-valid": "test_files/valid", "-as3":"test_files/assignment3_valid"}
    ...
    for test_type in test_types:
        if test_type == "-all":
            for all_t in valid_types:
                global_file_id = run_test_files(valid_types[all_t], all_t[1:], file_details, global_file_id)
            summary_generated = True

        elif test_type in valid_types:
